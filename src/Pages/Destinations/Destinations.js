        ...
        <div>
            <div className="des-banner text-center">
                <div className="content text-center">
                    ...
                    <p className="text-white">There are three basic forms of tourism: domestic tourism,  inbound tourism, and outbound tourism. <br /> Domestic tourism refers to activities of a visitor within their country of residence and outside of their home.</p>
                </div>
            </div>
